...
static const unsigned short int __ctype_b_internal[] = {
...
const unsigned short int * __ctype_b = __ctype_b_internal + 128;
...
const int * __ctype_toupper = __ctype_toupper_internal + 128;
...
const int * __ctype_tolower = __ctype_tolower_internal + 128;
